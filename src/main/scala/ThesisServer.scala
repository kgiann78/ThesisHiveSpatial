...
object ThesisServer {
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("ADD JAR hdfs://170.20.0.2:9000/jars/esri-geometry-api-1.2.1.jar")
    spark.sql("ADD JAR hdfs://170.20.0.2:9000/jars/spatial-sdk-hive-1.2.1-SNAPSHOT.jar")
    spark.sql("ADD JAR hdfs://170.20.0.2:9000/jars/spatial-sdk-json-1.2.1-SNAPSHOT.jar")
